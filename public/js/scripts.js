      ...
      function(require, module, exports) {
        (function(global) {
          ...
          function isSymbol(value) {
            return (
              (typeof value === "undefined" ? "undefined" : _typeof(value)) == "symbol" ||
    ...
    */
      ...
      function(require, module, exports) {
        ...
        var getListeners = function getListeners(type, handler) {
          ...
          var listener = {
            selector: selector,
            delegate:
              (typeof handler === "undefined" ? "undefined" : _typeof(handler)) === "object"
                ? delegateAll(handler)
                : selector
          ...
          if (typeof ids !== "string") {
            throw new Error(
              "Expected a string but got " +
                (typeof ids === "undefined" ? "undefined" : _typeof(ids))
            );
          }
    ...
    17: [
      function(require, module, exports) {
        ...
        var accordion = behavior(
          _defineProperty(
            {},
            CLICK,
            _defineProperty({}, BUTTON, function(event) {
    ...
    18: [
      function(require, module, exports) {
        ...
        module.exports = behavior(
          _defineProperty({}, CLICK, _defineProperty({}, HEADER + " [aria-controls]", toggleBanner))
        );
      },
      {
        "../config": 26,
    ...
    19: [
      function(require, module, exports) {
        ...
        module.exports = behavior(
          _defineProperty({}, CLICK, _defineProperty({}, BUTTON, showPanel)),
          {
      ...
      function(require, module, exports) {
        ...
        navigation = behavior(
          _defineProperty(
            ...
            _defineProperty(_CLICK, OPENERS, toggleNav),
            _defineProperty(_CLICK, CLOSERS, toggleNav),
            _defineProperty(_CLICK, NAV_LINKS, function() {
    ...
    24: [
      function(require, module, exports) {
        ...
        var LINK =
          "." + PREFIX + '-skipnav[href^="#"], .' + PREFIX + '-footer__return-to-top [href^="#"]';
        ...
        module.exports = behavior(
          _defineProperty({}, CLICK, _defineProperty({}, LINK, setTabindex))
        );
      },
      {
        "../config": 26,
      ...
      function(require, module, exports) {
        ...
        var sequence = function sequence() {
          ...
          return function callHooks() {
            ...
            var target =
              arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : document.body;
    ...
    39: [
      function(require, module, exports) {
        ...
        module.exports = function validate(el) {
          ...
          var checkList =
            id.charAt(0) === "#" ? document.querySelector(id) : document.getElementById(id);
